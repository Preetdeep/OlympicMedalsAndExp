...
m1<-m1+geom_bar(stat = "identity")+xlab("Appearance")+ylab("Average Number of Medals") +labs(title = "Average Number of Medals across Appearances")#Now olders are winning medals
print(m1)
